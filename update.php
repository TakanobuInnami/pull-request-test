...
<form  method="post" action ="" onsubmit="return check(this)">
  <dl>
    <dt>社員ID*</dt>
      <dd><input type="text" name="id" size="10" value="<?php echo htmlspecialchars($_SESSION['employee_id'],ENT_QUOTES)?>"><br></dd>
    <dt>社員名*</dt>
      <dd><input type="text" name="lastname"  value="<?php echo htmlspecialchars($_SESSION['family_name'],ENT_QUOTES)?>">
      <input type="text" name="firstname"  value="<?php echo htmlspecialchars($_SESSION['first_name'],ENT_QUOTES)?>"><br></dd>
    <dt>所属セクション*</dt>
    <dd>
      <select name="section">
